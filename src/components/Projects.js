        ...
        <div className="projects-content">
            ...
            <div className="project-item">
                ...
                <div  className="project-description popup">
                    ...
                    <div className="project-buttons">
                        <a href="/abijaudi" className="visit">{t('project.blog')}</a>
                    </div>
                </div>
            </div>
            ...
            <div className="project-item">
                ...
                <div  className="project-description popup">
                    ...
                    <div className="project-buttons">
                        <a href="/cruzeiro" className="visit">{t('project.blog')}</a>
                    </div>
                </div>
            </div>
            ...
            <div className="project-item">
                ...
                <div  className="project-description popup">
                    ...
                    <div className="project-buttons">
                        <a href="/paginanaoecontrada" className="visit">{t('project.blog')}</a>
                    </div>
                </div>
            </div>
